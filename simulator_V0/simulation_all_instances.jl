"""
ATRSC Project - Warehouse optimization — FIFO Algorithm
"""
...
workers = [
    Worker(1, [M1, M2, M3]),
    Worker(2, [M4, M5, M6]),
    Worker(3, [M1, M3, M6, M7, M8]),
    Worker(4, [M3, M5, M7, M8]),
    Worker(5, [M2, M6, M7]),
    Worker(6, [M1, M4, M7, M8])
]
instance_id = 4
=#
...
save_dossier(state, workers, t_ss, simulation_time, instance_id)
